...
const SingleAvis = ({ avis }: { avis: Aviss }) => {
  ...
  return (
    <div className="w-full">
      <div className="shadow-two hover:shadow-one dark:shadow-three dark:hover:shadow-gray-dark rounded-sm bg-white p-8 duration-300 dark:bg-[#181c24] lg:px-5 xl:px-8">
